...
#pragma pack(pop)
   ...
   void *detectAlgorithmLib_ConventionalDetect_new__IO(/* 图片的宽度 */const unsigned int width, /* 图片的高度 */const unsigned int height
        ...
        , /* 漂移半径 */const int iShiftRadius, /* 单个目标点数闸值 */const int ilimitNum, /* 长宽比 */const int iBarRatio, /* 目标跟踪,0-关闭,1-开启 */const char trackEnable, /* 最大转弯角度 */const int iMaxAngle, /* 匹配阈值计算控制 */ const double dLimitGauss
        ...
        , /* 区域 */FsConfigResult_area * const pArea, /* 区域中的点坐标参考的0点坐标,point_x+area_x0作为最终坐标 */const int area_x0, /* 区域中的点坐标参考的0点坐标,point_y+area_y0作为最终坐标 */const int area_y0);
