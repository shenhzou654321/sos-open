...
extern "C" {
    ...
    struct Camera_ctrl_hk_http_item *camera_ctrl_hk_http_item_new__IO(/* ipv4地址 */const unsigned int ipv4, /* ipv4地址端口号 */const unsigned short ipv4Port,
            /* 用户名,可为空 */const char username[], /* 密码,可为空 */const char password[]);
    ...
    unsigned long long camera_ctrl_hk_http_item_mask_get(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item);
    /* 控制,任意转 */
    void camera_ctrl_hk_http_item_ctl_turn_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040,负数向左,正数向右 */const short speedx,
            /* 参考值精度为23040,负数向上,正数向下 */const short speedy, /* 转动时间 */const float time);
    /* 控制,左转 */
    void camera_ctrl_hk_http_item_ctl_turnLeft_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,右转 */
    void camera_ctrl_hk_http_item_ctl_turnRight_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,上转 */
    void camera_ctrl_hk_http_item_ctl_turnUp_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,下转 */
    void camera_ctrl_hk_http_item_ctl_turnDown_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,左上转 */
    void camera_ctrl_hk_http_item_ctl_turnLeftUp_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,左下转 */
    void camera_ctrl_hk_http_item_ctl_turnLeftDown_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,右上转 */
    void camera_ctrl_hk_http_item_ctl_turnRightUp_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,右下转 */
    void camera_ctrl_hk_http_item_ctl_turnRightDown_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040 */const unsigned short speed, /* 转动时间 */const float time);
    /* 控制,变倍 */
    void camera_ctrl_hk_http_item_ctl_zoom_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040,负数缩小,正数放大 */const short speed, /* 变倍时间 */const float time);
    /* 控制,聚焦 */
    void camera_ctrl_hk_http_item_ctl_focus_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 参考值精度为23040,负数-,正数+ */const short speed, /* 聚焦时间 */const float time);
    /* 控制,设置预置位 */
    void camera_ctrl_hk_http_item_ctl_preset_set_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 预置位号 */const unsigned short presetIndex);
    /* 控制,调用预置位 */
    void camera_ctrl_hk_http_item_ctl_preset_goto_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 预置位号 */const unsigned short presetIndex);
    /* 控制,清除预置位 */
    void camera_ctrl_hk_http_item_ctl_preset_clean_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 预置位号 */const unsigned short presetIndex);
    /* 控制,3D定位 */
    void camera_ctrl_hk_http_item_ctl_zoom3D_pthreadSafety(struct Camera_ctrl_hk_http_item * const pCamera_ctrl_hk_item, /* 相对图大小参考值23040 */const unsigned short x1,
            /* 相对图大小参考值23040 */const unsigned short y1, /* 相对图大小参考值23040 */const unsigned short x2, /* 相对图大小参考值23040 */const unsigned short y2);
#ifdef FsDebug
    void camera_ctrl_hk_http_test();
#endif
#ifdef	__cplusplus
}
#endif
